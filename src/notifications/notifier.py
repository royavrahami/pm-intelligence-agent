...
class Notifier:
    ...
    def _build_email_html(
        ...
        """Build the complete PM email HTML with header, alerts, and embedded report."""
        if alert_trends:
            alert_items = "".join(
                f"""
                <div style="background:#fff8f8;border-left:4px solid #e94560;
                  ...
                  <p style="margin:6px 0 0;color:#374151;font-size:0.9em;">{t.description or ""}</p>
            ...
            <div style="background:#f0fdf4;border:1px solid #86efac;border-radius:8px;
              ...
              ✅ <strong style="color:#166534;">No critical PM alerts this cycle</strong>
            </div>"""
...
<body style="margin:0;padding:0;background:#f5f7fa;font-family:system-ui,sans-serif;">
  <div style="background:linear-gradient(135deg,#0f3460 0%,#1e40af 100%);
              color:white;padding:28px 32px;">
    <h1 style="margin:0;font-size:1.6rem;font-weight:700;">📋 PM Intelligence Report</h1>
